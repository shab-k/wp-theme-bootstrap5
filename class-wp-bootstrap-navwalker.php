...
if (!class_exists('WP_Bootstrap_Navwalker')) :
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
	{
		...
		public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
		{
			 ...
			 */
			//li
			$id = apply_filters('nav_menu_item_id', 'dropdown-item-' . $item->ID, $item, $args, $depth);
			...
			if ($this->has_children && 0 === $depth) {
				$atts['href']          = '#';
				$atts['data-toggle']   = 'nav-link dropdown-toggle';
		...
		public static function fallback($args)
		{
			...
			$fallback_output .= '<li class="nav-item dropdown"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link dropdown-toggle" title="' . esc_attr__('Add a menu', 'wp-bootstrap-navwalker') . '">' . esc_html__('Add a menu', 'wp-bootstrap-navwalker') . '</a></li>';
			$fallback_output .= '</ul>';
